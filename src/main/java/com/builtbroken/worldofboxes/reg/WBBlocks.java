...
public final class WBBlocks
{
    ...
    public static void registerBlocks(RegistryEvent.Register<Block> event)
    {
        ...
        event.getRegistry().register(new BlockNewLog().setUnlocalizedName(WorldOfBoxes.PREFIX + "log2").setRegistryName(WorldOfBoxes.DOMAIN, "log2"));
        ...
        event.getRegistry().register(new BlockNewLeaf().setUnlocalizedName(WorldOfBoxes.PREFIX + "leaves2").setRegistryName(WorldOfBoxes.DOMAIN, "leaves2"));
