...
public class ChunkGeneratorBoxworld implements IChunkGenerator
{
    ...
    public ChunkGeneratorBoxworld(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions)
    {
        {
    ...
    public boolean isInsideStructure(World worldIn, String structureName, BlockPos pos)
    {
        ...
        {
            return "Temple".equals(structureName);
        }
    }
